...
import static company.danhy.clothesuit.R.id.imagedep;

public class DepAdapter extends BaseAdapter {
    Context context;
    ArrayList<Sanpham>arrayListdep;

    public DepAdapter(Context context, ArrayList<Sanpham> arrayListdep) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            ...
            convertView=inflater.inflate(R.layout.dong_dep,null);
